...
The [design philosophy](/wiki/guide/components/design/) that shaped this framework inverts that: instead of probing from outside, ask directly. Trust the internal report as data.
