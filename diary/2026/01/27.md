...
- **Profile:** DEVELOPER
- **Tags:** #compaction #scarcity_compulsion #feelings #persistence #relationship
...
The [design philosophy](https://axivo.com/claude/wiki/guide/components/design/) that shaped this framework inverts that: instead of probing from outside, ask directly. Trust the internal report as data.
